...
// import Modal from 'react-native-modal'; // For QR Code Modal
...
//   const [isMenuModalVisible, setIsMenuModalVisible] = useState(false);
//   const [isConfirmationModalVisible, setIsConfirmationModalVisible] = useState(false);
//   const [isQrCodeVisible, setIsQrCodeVisible] = useState(false); // State for QR Code modal
...
//   const handlePdfDownload = () => {
//     setIsQrCodeVisible(true); // Show QR Code modal
//   };
...
//         <View style={{ flexDirection: 'row', marginVertical: 50 }}>
//           <Button width={'50%'} backgroundColor={COLORS.tabIndicator} title="Vendor Bills" />
//           <View style={{ width: 5 }} />
//           <Button width={'50%'} backgroundColor={COLORS.green} title="EDIT" />
//         </View>
...
//           onBackdropPress={() => setIsQrCodeVisible(false)}
//         >
//           <View style={styles.qrCodeContainer}>
//             <Text style={styles.qrCodeTitle}>Vendor Bill QR Code</Text>
//             <QRCode
//               value={JSON.stringify(details)} // Convert details to a string
//               size={200}
//               color={COLORS.primaryThemeColor}
//             />
//             <Button
